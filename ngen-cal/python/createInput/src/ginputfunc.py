...
def create_cfe_input(
    ...
    Parameters
    ----------
    overland_routing: overland flow routing scheme 
    ...
    for catID in catids:
        ...
        f.write("%s" %("surface_water_partitioning_scheme=Schaake\n"))
        ...
        f.write("%s" %("surface_runoff_scheme=" + overland_routing + "\n"))
