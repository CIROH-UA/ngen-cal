...
if __name__ == "__main__":
    ...
    general.name = "valid_control"
    conf["model"]["realization"] = "/ngen/ngen/data/calibration/realization.json"
    main(general, conf["model"])
    general.name = "valid_best"
    conf["model"]["realization"] = (
        "/ngen/ngen/data/calibration/Output/Validation_Run/realization.json"
    )
    main(general, conf["model"])
